...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($products->isNotEmpty()): ?>
    <section class="mt-4 overflow-hidden rounded-lg border border-red-200 bg-white shadow-sm" aria-label="<?php echo e($section->title ?? 'Deals & offers'); ?>">
        <div class="flex items-center justify-between gap-3 border-b border-red-100 bg-red-50 px-4 py-3">
            <div class="min-w-0">
                <h2 class="flex items-center gap-2 truncate text-base font-bold text-red-700 sm:text-lg">
                    ...
                    <?php echo e($section->title ?? 'Deals & offers'); ?>

                </h2>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($section->subtitle): ?><p class="mt-0.5 truncate text-xs text-red-600/80"><?php echo e($section->subtitle); ?></p><?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            </div>
            <a href="<?php echo e(route('shop', ['on_sale' => 1])); ?>" class="shrink-0 text-sm font-semibold text-red-700 hover:underline">All deals →</a>
        </div>
...
<?php /**PATH /Users/minhaz/multi blog site/hemdox-blogkit/resources/views/partials/homepage/on_sale.blade.php ENDPATH**/ ?>