...
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($products->isNotEmpty()): ?>
    <section class="mt-4 overflow-hidden rounded-lg border border-gray-200 bg-white shadow-sm" aria-label="<?php echo e($section->title ?? 'New arrivals'); ?>">
        <div class="flex items-center justify-between gap-3 border-b border-gray-100 px-4 py-3">
            <div class="min-w-0">
                <h2 class="flex items-center gap-2 truncate text-base font-bold text-gray-900 sm:text-lg">
                    <span class="h-5 w-1.5 shrink-0 rounded-full bg-teal-600"></span><?php echo e($section->title ?? 'New arrivals'); ?>
            ...
            <a href="<?php echo e(route('shop', ['sort' => 'latest'])); ?>" class="shrink-0 text-sm font-semibold text-teal-700 hover:underline">View all →</a>
        </div>
...
<?php /**PATH /Users/minhaz/multi blog site/hemdox-blogkit/resources/views/partials/homepage/new_arrivals.blade.php ENDPATH**/ ?>