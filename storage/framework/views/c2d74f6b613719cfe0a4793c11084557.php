...
?>
<?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($itemCount > 0 && ! $onCart): ?>
    <div
        x-data="{
            open: false,
            init() {
    ...
    >
        <div class="flex items-start gap-3">
            <div class="flex-1">
                <p class="text-sm font-semibold">You left <?php echo e($itemCount); ?> <?php echo e(Str::plural('item', $itemCount)); ?> in your cart</p>
                <p class="mt-1 text-xs text-gray-600">Finish checking out before something sells out.</p>
                <a href="<?php echo e(route('cart.index')); ?>" class="mt-2 inline-block text-sm font-medium text-indigo-600 hover:underline">View cart →</a>
            </div>
...
<?php /**PATH /Users/minhaz/multi blog site/hemdox-blogkit/resources/views/partials/cart-recovery-banner.blade.php ENDPATH**/ ?>