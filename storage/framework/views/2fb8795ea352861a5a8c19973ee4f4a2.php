...
<head>
    ...
    <title>Page not found — <?php echo e($site); ?></title>
    <style>
...
<body>
    <div class="card">
        ...
        <div class="actions">
            ...
            <a href="<?php echo e(url('/shop')); ?>" class="btn btn-ghost">Browse all products</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/minhaz/multi blog site/hemdox-blogkit/resources/views/errors/404.blade.php ENDPATH**/ ?>