...
<head>
    ...
    <title>Something went wrong — <?php echo e($site); ?></title>
    <style>
        ...
        <?php else: ?>
            <details class="report">
                ...
                <form method="POST" action="<?php echo e(url('/contact')); ?>">
                    ...
                    <input type="hidden" name="message" value="A visitor hit a server error (status <?php echo e($status); ?>) on <?php echo e(url()->current()); ?>. Check the admin error log for the technical detail.">
...
<?php /**PATH /Users/minhaz/multi blog site/hemdox-blogkit/resources/views/errors/friendly.blade.php ENDPATH**/ ?>