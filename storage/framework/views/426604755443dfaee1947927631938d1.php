...
<div class="not-prose my-8 grid gap-3 sm:grid-cols-3">
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($phone): ?>
        <a href="https://wa.me/<?php echo e(ltrim($whatsapp, '+')); ?>" target="_blank" rel="noopener"
           class="group rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:border-indigo-600 hover:shadow-md">
            ...
            <p class="mt-0.5 text-sm text-gray-600 group-hover:text-indigo-600"><?php echo e($phone); ?></p>
            <p class="mt-1 text-xs text-gray-400">Fastest reply, 7 days a week</p>
        </a>
        <a href="tel:<?php echo e($whatsapp); ?>"
           class="group rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:border-indigo-600 hover:shadow-md">
            <span class="flex h-10 w-10 items-center justify-center rounded-full bg-indigo-600 text-white">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($email): ?>
        <a href="mailto:<?php echo e($email); ?>"
           class="group rounded-2xl border border-gray-200 bg-white p-5 shadow-sm transition hover:border-indigo-600 hover:shadow-md">
            ...
            <p class="mt-0.5 break-all text-sm text-gray-600 group-hover:text-indigo-600"><?php echo e($email); ?></p>
            <p class="mt-1 text-xs text-gray-400">We reply within a few hours</p>
        </a>
    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
</div>
<?php /**PATH /Users/minhaz/multi blog site/hemdox-blogkit/resources/views/partials/contact-info.blade.php ENDPATH**/ ?>