...
<head>
    ...
    <title><?php echo e($site); ?> — coming soon</title>
    <style>
...
<body>
    <div class="card">
        <div class="logo"><?php echo e($site); ?></div>
        ...
        <div class="staff">
            ...
            <a href="<?php echo e(\Illuminate\Support\Facades\Route::has('filament.admin.auth.login') ? route('filament.admin.auth.login') : route('login')); ?>">Staff sign in</a>
        </div>
    </div>
</body>
</html>
<?php /**PATH /Users/minhaz/multi blog site/hemdox-blogkit/resources/views/errors/maintenance.blade.php ENDPATH**/ ?>