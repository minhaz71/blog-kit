...
return [
    ...
    */
    ...
    'payload' => [
        ...
        'max_nesting_depth' => 50,   // raised from 10: the rich-editor TipTap document (tables, nested lists) nests deeper than 10 dot-path levels and 500'd product saves   // Maximum depth of dot-notation property paths
